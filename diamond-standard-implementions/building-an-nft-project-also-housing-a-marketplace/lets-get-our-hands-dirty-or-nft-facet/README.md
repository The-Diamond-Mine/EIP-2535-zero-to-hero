...
As we have been made to understand, to give the diamond logic, it has to be done in a facet. So we would be creating a file in the Facets folder called ZeroToHeroCollection.sol, this is the file that would be housing the main NFT logic and would be inheriting the Base NFT contract.

To keep things organized, we would be creating a folder called utils in the contracts folder, this would be housing contracts that would be inherited in our facets.

In the Utils folder, Create a file called ERC721URIStorage.sol, this is what we have been regarding as the Base NFT contract that would be inherited by the Main NFT facet.

Enter this code in the ERC721URIStorage.sol
